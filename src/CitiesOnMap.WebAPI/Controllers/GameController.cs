...
{
    [HttpPost("start")]
    public async Task<ActionResult> StartGame(string? playerId = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult> GetNextQuestion(string gameId, CancellationToken cancellationToken)
    {
    ...
    [HttpPost("answer")]
    public async Task<ActionResult> SendAnswer(AnswerModel answer, CancellationToken cancellationToken)
    {
